...
namespace Avalonia.Controls
{
    ...
    public partial class NavigationView : ContentControl
    {
        ...
        public override void OnApplyTemplate()
        {
            ...
            // Change code to NOT do this if we're in top nav mode, to prevent it from being realized:
            if (this.Find<ItemsRepeater>(c_footerMenuItemsHost, controlProtected) is { } leftFooterMenuNavRepeater)
            {
            ...
            m_topNavContentOverlayAreaGrid = this.Find<Border>(c_topNavContentOverlayAreaGrid);
            ...
            m_paneContentGrid = GetTemplateChild(c_paneContentGridName) as IControl;

            m_contentLeftPadding = GetTemplateChild(c_contentLeftPadding) as IControl;
            ...
            m_paneTitleFrameworkElement = GetTemplateChild(c_paneTitleFrameworkElement) as IControl;
            m_paneTitlePresenter = GetTemplateChild(c_paneTitlePresenter) as ContentControl;

            if (GetTemplateChild(c_paneTitleHolderFrameworkElement) is IControl paneTitleHolderFrameworkElement)
            {
            ...
            if (CoreApplicationViewTitleBar.GetTitleBar(this) is { } coreTitleBar)
            {
                ...
                {
                    m_togglePaneTopPadding = GetTemplateChild(c_togglePaneTopPadding) as IControl;
                    m_contentPaneTopPadding = GetTemplateChild(c_contentPaneTopPadding) as IControl;
                }
            }
        ...
        void OnNavigationViewItemIsSelectedPropertyChanged(AvaloniaObject sender, AvaloniaProperty args)
        {
        ...
        void OnNavigationViewItemExpandedPropertyChanged(AvaloniaObject sender, AvaloniaProperty args)
        {
            if (sender is NavigationViewItem nvi)
            {
                if (nvi.IsExpanded)
        ...
        bool IsRootItemsRepeater(AvaloniaObject element)
        {
            if (element != null)
            {
        ...
        bool IsRootGridOfFlyout(AvaloniaObject element)
        {
        ...
        NavigationViewItem GetParentNavigationViewItemForContainer(NavigationViewItemBase nvib)
        {
            ...
            AvaloniaObject parent = GetParentItemsRepeaterForContainer(nvib);
        ...
        IndexPath GetIndexPathForContainer(NavigationViewItemBase nvib)
        {
            ...
            if (parent == m_topNavRepeaterOverflowView)
            {
                ...
                var containerIndex = m_topNavRepeaterOverflowView.GetElementIndex(child as IControl);
            ...
            {
                // Convert index of selected item in overflow to index in datasource
                var containerIndex = m_topNavRepeater.GetElementIndex(child as IControl);
            ...
            {
                path.Insert(0, parentIR.GetElementIndex(child as IControl));
            }
        ...
        internal void OnRepeaterElementPrepared(object ir, ItemsRepeaterElementPreparedEventArgs args)
        {
        ...
        void OnSplitViewClosedCompactChanged(AvaloniaObject sender, AvaloniaProperty args)
        {
        ...
        void OnSplitViewPaneClosed(AvaloniaObject sender, object obj)
        {
            PaneClosed?.Invoke(this, null);
        }

        void OnSplitViewPaneClosing(AvaloniaObject sender, SplitViewPaneClosingEventArgs args)
        {
            bool pendingPaneClosingCancel = false;
            if (PaneClosing != null)
            {
        ...
        void OnSplitViewPaneOpened(AvaloniaObject sender, object obj)
        {
            PaneOpened?.Invoke(this, null);
        }

        void OnSplitViewPaneOpening(AvaloniaObject sender, object obj)
        {
            if (m_leftNavRepeater != null)
            {
                // See UpdateIsClosedCompact 'RS3+ animation timing enhancement' for explanation:
        ...
        Action SetPaneTitleFrameworkElementParent(ContentControl parent, IControl paneTitle, bool shouldNotContainPaneTitle)
        {
            if (parent != null)
            {
        ...
        void AnimateSelectionChanged(object nextItem)
        {
            ...
            IControl prevIndicator = m_activeIndicator;
            IControl nextIndicator = FindSelectionIndicator(nextItem);
            ...
            {
                IControl paneContentGrid = m_paneContentGrid;
        ...
        void PlayIndicatorNonSameLevelAnimations(IControl indicator, bool isOutgoing, bool fromTop, TimelineCollection animations)
        {
        ...
        void PlayIndicatorNonSameLevelTopPrimaryAnimation(IControl indicator, bool isOutgoing, TimelineCollection animations)
        {
            // Determine scaling of indicator (whether it is appearing or dissapearing)
            double beginScale = isOutgoing ? 1.0 : 0.0;
            double endScale = isOutgoing ? 0.0 : 1.0;
        ...
        void PlayIndicatorAnimations(IControl indicator, double from, double to, Size beginSize, Size endSize, bool isOutgoing, TimelineCollection animations)
        {
            Size size = indicator.RenderSize;
            double dimension = IsTopNavigationView() ? size.Width : size.Height;
        ...
        void PrepareIndicatorForAnimation(IControl indicator, Point? centerPoint = null)
        {
        ...
        void ResetElementAnimationProperties(IControl element, double desiredOpacity)
        {
            if (element != null)
            {
                ...
                {
                    element.ClearValue(IControl.RenderTransformProperty);
                }
        ...
        IControl FindSelectionIndicator(object item)
        {
            if (item != null)
            {
        ...
        */
        ...
        internal object MenuItemFromContainer(AvaloniaObject container)
        {
            if (container != null)
            {
        ...
        internal AvaloniaObject ContainerFromMenuItem(object item)
        {
            if (item != null)
            {
        ...
        */
        ...
        NavigationRecommendedTransitionDirection GetRecommendedTransitionDirection(AvaloniaObject prev, AvaloniaObject next)
        {
        ...
        void OnSelectedItemPropertyChanged(AvaloniaPropertyChangedEventArgs args)
        {
                ...
                for (int i = 0; i < size; i++)
                {
                    if (i != selectedItemIndexInPrimary)
                    {
                        ...
                        if (requiredWidth <= availableWidth)
                        {
                            ...
                            if (container != null)
                            {
                                if (container is IControl containerAsUIElement)
                                {
        ...
        void PropertyChanged(AvaloniaPropertyChangedEventArgs args)
        {
        ...
        void OnRepeaterIsVisibleChanged(object sender, AvaloniaPropertyChangedEventArgs e)
        {
            if ((bool)e.NewValue)
            {
                Dispatcher.BeginInvoke(() =>
        ...
        {
            IControl autoSuggestBoxContentControl = null;
            IControl notControl = null;
            if (!IsTopNavigationView())
            {
        ...
        void UpdateTitleBarPadding()
        {
            ...
            if (m_coreTitleBar is { } coreTitleBar)
            {
                ...
                if (needsTopPadding)
                {
                    ...
                    IControl root = (Window.GetWindow(this) ?? Application.Current.MainWindow).Content as IControl;
        ...
        IControl SearchEntireTreeForContainer(ItemsRepeater rootRepeater, object data)
        {
        ...
        void RecycleContainer(IControl container)
        {
        ...
        IControl GetContainerForIndex(int index, bool inFooter)
        {
            if (IsTopNavigationView())
            {
        ...
        NavigationViewItemBase GetContainerForIndexPath(IControl firstContainer, IndexPath ip, bool lastVisible)
        {
        ...
        object GetChildrenForItemInIndexPath(IControl firstContainer, IndexPath ip, bool forceRealize = false)
        {
            var container = firstContainer;
        ...
        IControl m_paneContentGrid;
        ColumnDefinition m_paneToggleButtonIconGridColumn;
        IControl m_paneTitleHolderFrameworkElement;
        IControl m_paneTitleFrameworkElement;
        ...
        IControl m_prevIndicator;
        IControl m_nextIndicator;
        IControl m_activeIndicator;
        object m_lastSelectedItemPendingAnimationInTopNav;

        IControl m_togglePaneTopPadding;
        IControl m_contentPaneTopPadding;
        IControl m_contentLeftPadding;
        ...
        static readonly PropertyPath s_centerXPath = new PropertyPath("(IControl.RenderTransform).(TransformGroup.Children)[0].(ScaleTransform.CenterX)");
        static readonly PropertyPath s_centerYPath = new PropertyPath("(IControl.RenderTransform).(TransformGroup.Children)[0].(ScaleTransform.CenterY)");
        static readonly PropertyPath s_scaleXPath = new PropertyPath("(IControl.RenderTransform).(TransformGroup.Children)[0].(ScaleTransform.ScaleX)");
        static readonly PropertyPath s_scaleYPath = new PropertyPath("(IControl.RenderTransform).(TransformGroup.Children)[0].(ScaleTransform.ScaleY)");
        static readonly PropertyPath s_translateXPath = new PropertyPath("(IControl.RenderTransform).(TransformGroup.Children)[1].(TranslateTransform.X)");
        static readonly PropertyPath s_translateYPath = new PropertyPath("(IControl.RenderTransform).(TransformGroup.Children)[1].(TranslateTransform.Y)");
    }
}
